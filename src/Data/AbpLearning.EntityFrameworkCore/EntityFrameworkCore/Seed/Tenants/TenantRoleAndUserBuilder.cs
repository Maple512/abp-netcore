namespace AbpLearning.EntityFrameworkCore.EntityFrameworkCore.Seed.Tenants
{
    ...
    public class TenantRoleAndUserBuilder
    {
        ...
        public TenantRoleAndUserBuilder(AbpLearningDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var permissions = PermissionFinder.GetAllPermissions(AbpLearningAuthorizationProvider.GetAllPermission())
