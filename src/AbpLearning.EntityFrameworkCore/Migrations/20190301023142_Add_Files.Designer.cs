...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbpLearning.Core.CloudBookLists.BookLists.BookList", b =>
                {
                    ...
                    b.Property<byte>("ExsitedBookCount");
            ...
            modelBuilder.Entity("AbpLearning.Core.Files.FileType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AbpLearning.Core.Files.UploadFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AbpLearning.Core.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AbpLearning.Core.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("AbpLearning.Core.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("AbpLearning.Core.Authorization.Users.User", "DeleterUser")
                        .WithMany()
            ...
            modelBuilder.Entity("AbpLearning.Core.Files.UploadFile", b =>
                {
                    b.HasOne("AbpLearning.Core.Files.FileType", "TypeName")
                        .WithMany()
